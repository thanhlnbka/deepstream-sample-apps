...
if [ -n $TARGET_DEVICE ]; then
  if [ "${TARGET_DEVICE}" = "x86_64" ]; then
    ...
    update-alternatives --remove deepstream-ucx-test1-app-server /opt/nvidia/deepstream/deepstream-${PREV_DS_VER}/bin/deepstream-ucx-test1-app-server
    update-alternatives --remove deepstream-ucx-test1-app-client /opt/nvidia/deepstream/deepstream-${PREV_DS_VER}/bin/deepstream-ucx-test1-app-client
    update-alternatives --remove deepstream-ucx-test2-app-server /opt/nvidia/deepstream/deepstream-${PREV_DS_VER}/bin/deepstream-ucx-test2-app-server
    update-alternatives --remove deepstream-ucx-test2-app-client /opt/nvidia/deepstream/deepstream-${PREV_DS_VER}/bin/deepstream-ucx-test2-app-client
    update-alternatives --remove deepstream-ucx-test3-app-server /opt/nvidia/deepstream/deepstream-${PREV_DS_VER}/bin/deepstream-ucx-test3-app-server
    update-alternatives --remove deepstream-ucx-test3-app-client /opt/nvidia/deepstream/deepstream-${PREV_DS_VER}/bin/deepstream-ucx-test3-app-client
...
update-alternatives --remove deepstream-audio /opt/nvidia/deepstream/deepstream-6.3/bin/deepstream-audio
