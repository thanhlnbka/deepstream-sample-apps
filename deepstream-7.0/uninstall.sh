...
update-alternatives --remove deepstream-audio /opt/nvidia/deepstream/deepstream-7.0/bin/deepstream-audio
...
update-alternatives --remove service-maker-test1-app /opt/nvidia/deepstream/deepstream-${PREV_DS_VER}/bin/service-maker-test1-app PRIORITY
update-alternatives --remove service-maker-test2-app /opt/nvidia/deepstream/deepstream-${PREV_DS_VER}/bin/service-maker-test2-app PRIORITY
update-alternatives --remove service-maker-test3-app /opt/nvidia/deepstream/deepstream-${PREV_DS_VER}/bin/service-maker-test3-app PRIORITY
update-alternatives --remove service-maker-test4-app /opt/nvidia/deepstream/deepstream-${PREV_DS_VER}/bin/service-maker-test4-app PRIORITY
update-alternatives --remove service-maker-test5-app /opt/nvidia/deepstream/deepstream-${PREV_DS_VER}/bin/service-maker-test5-app PRIORITY
