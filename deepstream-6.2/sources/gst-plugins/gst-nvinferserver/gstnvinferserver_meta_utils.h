...
void attachDetectionMetadata(
    ...
    uint32_t offsetLeft, uint32_t offsetTop, uint32_t roiLeft, uint32_t roiTop, uint32_t imageWidth,
    uint32_t imageHeight, uint32_t uniqueId, const ic::PluginControl& config);
